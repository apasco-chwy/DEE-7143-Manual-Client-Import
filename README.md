...
| Clinic uses non-integrated vendor | Not possible  | Wants to migrate at onboarding  | Clinic will not have to re-enter existing data, but will have to double-enter all new data moving forward  |
